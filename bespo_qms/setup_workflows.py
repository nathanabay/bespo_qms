...
def create_workflows():
    ...
    if not frappe.db.exists("Workflow", workflow_name):
        ...
        doc.append("states", {"state": "Draft", "allow_edit": "System Manager", "doc_status": "0"})
        doc.append("states", {"state": "Actioned", "allow_edit": "System Manager", "doc_status": "1"})
        
        doc.append("transitions", {"state": "Draft", "action": "Complete", "next_state": "Actioned", "allowed": "System Manager"})
